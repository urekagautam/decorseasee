...
if( defined( 'MAILPOET_VERSION' ) ){
	function xoo_el_mailpoet_subscribe( $data ){
		...
		$_POST['mailpoet']['subscribe_on_register'] = isset( $_POST['xoo-mailpoet-subscribe'] ) && trim( $_POST['xoo-mailpoet-subscribe'] ) ? '1' : '0';

	}
	add_action( 'xoo_el_register_customer_extra_data', 'xoo_el_mailpoet_subscribe' );
}
