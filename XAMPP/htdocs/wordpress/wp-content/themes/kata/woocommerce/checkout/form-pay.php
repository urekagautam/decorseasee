...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'kata' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'kata' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'kata' ); ?></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="payment">
		<h2 class="checkout-step-title billing-details-title"><?php esc_html_e( 'Payment Method', 'kata' ); ?></h2>
